...
- [Clean Authorization Deep-Module and Atomic Cutover Plan](docs/15-DEVELOPMENT/authz_v2_clean_cutover_plan.md) - Decision-complete plan for one typed authorization engine, scoped-grant schema, DTO/API boundaries, Flask enforcement, audit logging, and removal of every legacy authorization path
- [Authz v2 Live-Consumer Inventory](docs/15-DEVELOPMENT/authz_v2_live_consumer_inventory.md) - Reproducible 680-route, 47-task, and 977 list-candidate baseline with explicit migration gaps and concrete relationship-query policy classifications
- [Authorization API](docs/API/authorization/README.md) - Cutover-staged catalogue and unified grant list/create/update contracts with exact scoping, delegation, CSRF, and transactional audit rules
