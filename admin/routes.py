...
from models import Area, Camera, Disease, DiseaseGrading, Hospital, LabUnit, Role, Session, User, BASE_DIR  # ← uses your session factory & model
import os
...
@admin_bp.route("/disease-gradings", methods=["GET", "POST"])
@roles_required("admin")
...
@admin_bp.route("/disease-gradings/new", methods=["GET", "POST"])
@roles_required("admin")
...
@admin_bp.route("/disease-gradings/<int:grading_id>/edit", methods=["GET", "POST"])
@roles_required("admin")
...
@admin_bp.route("/disease-gradings/<int:grading_id>/delete", methods=["POST"])
@roles_required("admin")
