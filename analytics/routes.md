...
- **Data Scoping**: Access is restricted to data belonging to the user's associated lab units. Users can only view image grading results for encounters in their lab units. Filtering by lab_unit_id is only allowed if the user has access to that lab unit.
...
- **Query Parameters**:
  ...
  - `lab_unit_id`: Filter by lab unit ID (restricted to user's accessible units)
...
- **HTTP Methods**: GET
- **Roles Required**: admin, data_manager
- **Data Scoping**: Access is restricted to encounters belonging to the user's associated lab units. Users can only view encounters they have permission to access based on lab unit association. Filtering by lab_unit_id is only allowed if the user has access to that lab unit.
...
- **Data Scoping**: Access is restricted to images belonging to the user's associated lab units. Users can only view images from their assigned lab units. Filtering by lab_unit_id is only allowed if the user has access to that lab unit.
...
- **HTTP Methods**: GET
- **Roles Required**: admin, data_manager, optometrist
- **Data Scoping**: Search results are restricted to images belonging to the user's associated lab units. Users can only search within their assigned lab units. Filtering by lab_unit_id is only allowed if the user has access to that lab unit.
...
- **HTTP Methods**: GET
- **Roles Required**: admin, data_manager, optometrist
- **Data Scoping**: Access is restricted to direct image uploads belonging to the user's associated lab units. Users can only view images they have permission to access based on lab unit association.
...
- **HTTP Methods**: GET
- **Roles Required**: admin, data_manager, optometrist
- **Data Scoping**: Access is restricted to grading tasks belonging to the user's associated lab units. Users can only review discrepancies for tasks within their assigned lab units. Filtering by lab_unit_id is only allowed if the user has access to that lab unit.
