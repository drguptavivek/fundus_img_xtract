#!/usr/bin/env python3
"""
Debug script to test rate limiting decorators in the test environment.
"""
...
def test_decorators_in_test_environment():
    """Test the rate limit decorators in a test-like environment."""
    app = Flask(__name__)
    app.config.update(
        TESTING=True,
...
if __name__ == "__main__":
    test_decorators_in_test_environment()