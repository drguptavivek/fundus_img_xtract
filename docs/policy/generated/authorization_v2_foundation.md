...
Authorize admin.ai_models.view.
...
Resource: `grading_repair_target`; disclosure: `masked`; audit: `required`.

- `admin_break_glass`: ActivePrincipalRequirement(authenticated=True), BooleanRequirement(fact=exact_resource; expected=True), IdentifierReleaseRequirement(), BooleanRequirement(fact=domain_valid; expected=True), ScopedRoleRequirement(roles=admin; allow_system=True)

### `admin.grading_repair.reset_batch`

Authorize admin.grading_repair.reset_batch.

Resource: `grading_repair_batch`; disclosure: `masked`; audit: `required`.
...
Authorize admin.lookup_record.manage.

Resource: `lookup_record`; disclosure: `masked`; audit: `required`.

- `admin_break_glass`: ActivePrincipalRequirement(authenticated=True), BooleanRequirement(fact=exact_resource; expected=True), IdentifierReleaseRequirement(), BooleanRequirement(fact=domain_valid; expected=True), ScopedRoleRequirement(roles=admin; allow_system=True)

### `admin.lookup_record.view`

Authorize admin.lookup_record.view.
...
Authorize admin.metadata.operation.
...
Authorize admin.storage.operation.
...
Authorize admin.upload_metadata_fields.create.

Resource: `system_operation`; disclosure: `masked`; audit: `optional`.

- `admin_break_glass`: ActivePrincipalRequirement(authenticated=True), BooleanRequirement(fact=exact_resource; expected=True), IdentifierReleaseRequirement(), ScopedRoleRequirement(roles=admin; allow_system=True)

### `admin.upload_metadata_fields.manage`

Authorize admin.upload_metadata_fields.manage.

Resource: `upload_metadata_field_definition`; disclosure: `identifier_in_place`; audit: `optional`.

- `admin_break_glass`: ActivePrincipalRequirement(authenticated=True), BooleanRequirement(fact=exact_resource; expected=True), IdentifierReleaseRequirement(), ScopedRoleRequirement(roles=admin; allow_system=True)

### `admin.upload_metadata_fields.view`

Authorize admin.upload_metadata_fields.view.
...
Authorize admin.upload_quota.manage.
...
Authorize media.ocr_pii.batch.read.

Resource: `image_batch`; disclosure: `identifier_in_place`; audit: `optional`.
...
Authorize project.remote_inference_batch.run.

Resource: `remote_inference_batch`; disclosure: `masked`; audit: `optional`.
...
Authorize project.remote_inference_config.manage.
...
Authorize project.remote_inference_config.view.
...
Authorize project.remote_inference_job.resume.
...
### `review.discrepancy.history`

Authorize review.discrepancy.history.
...
Authorize review.discrepancy.list.

Resource: `screen`; disclosure: `masked`; audit: `optional`.

- `authenticated_screen`: ActivePrincipalRequirement(authenticated=True), AnyRoleRequirement(roles=data_exporter,discrepancy_reviewer), GrantSourceRequirement(sources=authorization_grant)
- `admin_break_glass`: ActivePrincipalRequirement(authenticated=True), AnyRoleRequirement(roles=admin), GrantSourceRequirement(sources=authorization_grant)
...
### `review.regrade_creator.view`

Authorize review.regrade_creator.view.
