...
def main() -> None:
    ...
    parser.add_argument(
        "--migrate-dual-grading",
        action="store_true",
        help="Create tables for the dual grading feature.",
    )
    parser.add_argument(
        "--batch-size",
        type=int,
    ...
    if args.migrate_dual_grading:
        print("Ensuring dual grading tables exist...")
        # The tables are created by `create_tables()` at the start of the script if they are missing.
        # This is just a formal entry point for the migration.
        print("Dual grading tables are ready.")
