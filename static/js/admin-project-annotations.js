  ...
  function addProjectClass(panel, projectClass) {
    ...
    row.innerHTML =
      '<div class="row g-2 align-items-end">' +
        ...
        '<div class="col-12 col-md-4 col-xl-1 text-md-end"><button class="btn btn-outline-danger" type="button" data-class-delete aria-label="Delete project class">Delete</button></div>' +
      '</div>';
