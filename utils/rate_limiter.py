...
def init_rate_limiting(app):
    ...
    app.config['RATELIMIT_DEFAULT'] = os.getenv('RATELIMIT_DEFAULT', '4000 per hour, 400 per minute')
    ...
    app.config['RATELIMIT_APPLICATION'] = os.getenv('RATELIMIT_APPLICATION', '10000 per hour, 400 per minute')
